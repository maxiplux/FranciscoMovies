...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        // seteamos las notificaciones con cantidad de elementos en la db
        ...
        // si hay datos se procesaran , porque la funcion updateFavoritesBadge
        // enviara la notificacion , esencial declarar en la parte superior esto
    ...
    @objc func updateFavoritesBadgeNotification(notification: Notification) {
        ...
        // lo que envia la funcion de notificar desde la db , se procesa aqui
        // porque la funcion  tiene a nivel de dataProvider , el objecto que envia la notificacion
