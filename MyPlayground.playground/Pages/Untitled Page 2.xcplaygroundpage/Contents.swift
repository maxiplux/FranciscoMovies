...
class RemoteItunes {
    ...
    static func getTopMovies(completionHandler: @escaping ([[String:String]]?) -> Void)
    {
    ...
    static func searchMovies(byTerm: String, completionHandler: @escaping ([[String:String]]?) -> Void) {
